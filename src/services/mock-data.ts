...
export const MOCK_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    contributions: [
      'Architected independent microservices (API Gateway, User, Product, Order) adhering to Domain-Driven Design (DDD) and Clean Architecture.',
      'Engineered atomic stock deduction using Redis Lua Scripts and Idempotency-Key middlewares to prevent overselling and double-charging during flash sale traffic surges.',
      'Implemented Redis Cache-Aside combined with Go singleflight to eliminate Cache Stampede (Thundering Herd) on high-traffic product catalog queries.',
      'Integrated Apache Kafka for real-time batching of product view statistics and RabbitMQ with Dead Letter Queues (DLX) for reliable asynchronous order processing.',
      'Constructed centralized observability pipeline via GELF UDP structured logging into Graylog & OpenSearch with end-to-end X-Request-ID distributed trace correlation.',
    ],
    architecture: {
