...
export const EN_DATA: I18nDataBundle = {
  ui: {
    ...
    hero: {
      readyBadge: {
        prefix: 'Open for Hire: ',
        role1: 'Java • Node.js',
        and: ' & ',
        role2: 'Go • React',
      },
      greeting: "Hi, I'm",
      focusPrefix: 'Experience & focus on',
      typingRoles: [
        'Backend Developer with Java Spring Boot & Spring Security',
        'Backend Developer with Node.js, Express & MongoDB',
        'Backend Developer with Golang & Microservices Architecture',
        'Frontend & Fullstack Developer with ReactJS & Next.js',
      ],
      badges: {
    ...
    contactSection: {
      ...
      subtitle:
        'Open for full-time opportunities in Golang Backend or Blockchain Engineering.',
